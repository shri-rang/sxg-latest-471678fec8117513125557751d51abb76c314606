...
class TeacherUpcomingClasses extends StatefulWidget {
  final String id;

  TeacherUpcomingClasses({this.id});
  @override
  _TeacherUpcomingClassesState createState() => _TeacherUpcomingClassesState();
}

class _TeacherUpcomingClassesState extends State<TeacherUpcomingClasses> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: FutureBuilder<List<CompletedLiveModelTeacher>>(
        future: _netWorkAPiRepository.teacherUpcomingClasses(
          widget.id,
        ),
        builder:
